        ...
        <div className='max-w-7xl mx-auto px-16'>
            <div className='grid md:grid-cols-2 gap-18 items-center'>
                <div>
                    ...
                    <p className='text-xl mb-6 text-blue-100'>Discover cutting-edge techology with unbeatable deals on smartphones, laptops and more.</p>
                ...
                <div className='relative'>
                    <img src='hero-image.png' alt='image' width={300} height={1} className='rounded-lg shadow-xl ms-16 mt-4'/>
                </div>
            </div>
        </div>
    </section>
