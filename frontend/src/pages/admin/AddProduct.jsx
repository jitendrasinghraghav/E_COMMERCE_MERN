...
const AddProduct = () => {
    ...
    const submitHandler = async (e) => {
        ...
        // Appending multiple image files
        ...
        try {
            ...
            const res = await axios.post(`http://localhost:8000/api/v1/product/add`, formData, {
                headers: {
                    "Content-Type":"multipart/form-data", // Ye line add karein
    ...
    return (
        <div className='pl-[350px] py-1 pr-16 mx-auto px-2 bg-gray-100'>
            <Card className='w-full my-18'>
                <CardHeader>
