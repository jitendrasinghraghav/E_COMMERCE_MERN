...
const UserInfo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // The API call (axios or fetch) would typically go here
  ...
  return (
    <div className='pt-10 min-h-screen bg-gray-100'>
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col justify-center items-center min-h-screen bg-gray-100 ml-30 pl-10'>
          ...
          <div className='w-full flex gap-10 justify-between items-start px-7 max-w-2xl'>
            ...
            <div className='flex flex-col items-center'>
              ...
              />
              <Label className='mt-3 cursor-pointer bg-pink-600 text-white px-4 py-2 rounded-lg hover:bg-pink-700'>
                Change Picture
                ...
                className='flex items-center'>
                  ...
                  <div className='flex items-center space-x-2'>
                    <RadioGroupItem
                      value="user"
                      id="user"
                      className="border-pink-600 text-pink-600 focus:ring-pink-600"
                    />
